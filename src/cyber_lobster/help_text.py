...
6. 开机自动守护:
   cyber-lobster autostart enable
   cyber-lobster autostart
   cyber-lobster autostart disable
...
普通用户不需要改。高级用户可以运行:
  ...
  cyber-lobster storage
  cyber-lobster storage D:\\MyData\\cyber-lobster

恢复默认位置:

  cyber-lobster storage --reset

常见问题
----------------------------------------
Q: 换电脑后配置文件能直接用吗？
A: 账号配置可以复制，但 Windows DPAPI 保护的密码不能跨用户/跨电脑解密。
   换电脑后运行 cyber-lobster add 重新输入密码即可。
